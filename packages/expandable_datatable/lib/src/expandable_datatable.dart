...
class ExpandableDataTable extends StatefulWidget {
  ...
  /// If true, the row can be expanded by tapping on the row.
  /// If false, the row can be expanded by tapping on the expansion icon.
  /// It defaults to false.
  final bool tapRowToExpand;
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: custom_tile.ExpansionTile(
          controlAffinity: context.expandableTheme.controlAffinity,
          ...
          tapRowToExpand: widget.tapRowToExpand,
