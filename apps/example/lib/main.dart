            ...
            ? LayoutBuilder(builder: (context, constraints) {
                ...
                return ExpandableTheme(
                  data: ExpandableThemeData(
                    ...
                    expansionIcon: const Icon(Icons.arrow_drop_down),
                  ...
                  child: ExpandableDataTable(
                    ...
                    rows: rows,
                    pageSize: 20,
                    alwaysEnableCustomExpansionContent: true,
                    ...
                    renderExpansionContent: (row) {
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("ID: ${row.cells[0].value}"),
                            Text("First name: ${row.cells[1].value}"),
                            Text("Last name: ${row.cells[2].value}"),
                            Text("Maiden name: ${row.cells[3].value}"),
                            Text("Age: ${row.cells[4].value}"),
                          ],
                        ),
                      );
                    },
